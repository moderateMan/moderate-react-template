      ...
      formItemArr: [
        {
          ...
          formConfig: {
            ...
            inputConfig: {
              placeholder: intlData["light_placeholder_lightName"],
              maxLength: 30,
              size: "large",
            },
          },
        },
        {
          ...
          formConfig: {
            ...
            type: "TextArea",
            inputConfig: {
              placeholder: intlData["light_placeholder_comment"],
              autoSize: { minRows: 4 },
              maxLength: 60,
            },
          },
      ...
      columns: [
        {
          ...
          formConfig: {
            ...
            type: "Select",
            render: ({ inputConfig, optionArr, setFieldsValue }: any) => {
              return (
                <Select {...inputConfig}>
                  {optionArr &&
                    optionArr.length > 0 &&
